//heavily inspired: https://github.com/arcuri82/web_development_and_api_design/blob/master/exercise-solutions/quiz-game/part-10/src/client/signup.jsx
...
export class SignUp extends React.Component {
    ...
    doSignUp = async () => {
        ...
        if (confirm !== password) {
            this.setState({errorMsg: "Passwords not matching!!"});
            return;
        }
        ...
        if (response.status === 400) {
            this.setState({errorMsg: "Invalid username and/or password"});
            return;
        }
